...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.dataPerangkatKera.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.data-perangkat-keras.update", [$dataPerangkatKera->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('nomor_rak') ? 'is-invalid' : '' }}" name="nomor_rak_id" id="nomor_rak_id" required>
                    @foreach($nomor_raks as $id => $entry)
                        <option value="{{ $id }}" {{ (old('nomor_rak_id') ? old('nomor_rak_id') : $dataPerangkatKera->nomor_rak->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('nama_merk') ? 'is-invalid' : '' }}" name="nama_merk_id" id="nama_merk_id" required>
                    @foreach($nama_merks as $id => $entry)
                        <option value="{{ $id }}" {{ (old('nama_merk_id') ? old('nama_merk_id') : $dataPerangkatKera->nama_merk->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('nama_jenis') ? 'is-invalid' : '' }}" name="nama_jenis_id" id="nama_jenis_id">
                    @foreach($nama_jenis as $id => $entry)
                        <option value="{{ $id }}" {{ (old('nama_jenis_id') ? old('nama_jenis_id') : $dataPerangkatKera->nama_jenis->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tipe') ? 'is-invalid' : '' }}" type="text" name="tipe" id="tipe" value="{{ old('tipe', $dataPerangkatKera->tipe) }}">
                @if($errors->has('tipe'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('serial_number') ? 'is-invalid' : '' }}" type="text" name="serial_number" id="serial_number" value="{{ old('serial_number', $dataPerangkatKera->serial_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tahun_beli') ? 'is-invalid' : '' }}" type="number" name="tahun_beli" id="tahun_beli" value="{{ old('tahun_beli', $dataPerangkatKera->tahun_beli) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomor_u') ? 'is-invalid' : '' }}" type="text" name="nomor_u" id="nomor_u" value="{{ old('nomor_u', $dataPerangkatKera->nomor_u) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('keterangan') ? 'is-invalid' : '' }}" name="keterangan" id="keterangan">{{ old('keterangan', $dataPerangkatKera->keterangan) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ip') ? 'is-invalid' : '' }}" type="text" name="ip" id="ip" value="{{ old('ip', $dataPerangkatKera->ip) }}">
                @if($errors->has('ip'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('tahun_berakhir_garansi') ? 'is-invalid' : '' }}" type="text" name="tahun_berakhir_garansi" id="tahun_berakhir_garansi" value="{{ old('tahun_berakhir_garansi', $dataPerangkatKera->tahun_berakhir_garansi) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kontak_pic') ? 'is-invalid' : '' }}" type="text" name="kontak_pic" id="kontak_pic" value="{{ old('kontak_pic', $dataPerangkatKera->kontak_pic) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('nama_status') ? 'is-invalid' : '' }}" name="nama_status_id" id="nama_status_id">
                    @foreach($nama_statuses as $id => $entry)
                        <option value="{{ $id }}" {{ (old('nama_status_id') ? old('nama_status_id') : $dataPerangkatKera->nama_status->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('nama_lokasi') ? 'is-invalid' : '' }}" name="nama_lokasi_id" id="nama_lokasi_id">
                    @foreach($nama_lokasis as $id => $entry)
                        <option value="{{ $id }}" {{ (old('nama_lokasi_id') ? old('nama_lokasi_id') : $dataPerangkatKera->nama_lokasi->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ruang_panel') ? 'is-invalid' : '' }}" type="text" name="ruang_panel" id="ruang_panel" value="{{ old('ruang_panel', $dataPerangkatKera->ruang_panel) }}">
